...
IF(NOT EXISTS "/home/runner/work/jrl-cmakemodules/jrl-cmakemodules/build/install_manifest.txt")
  RETURN()
ENDIF(NOT EXISTS "/home/runner/work/jrl-cmakemodules/jrl-cmakemodules/build/install_manifest.txt")

MESSAGE(STATUS "catkin path: /usr/local/.catkin")
IF(EXISTS "/usr/local/.catkin" AND PACKAGE_CREATES_DOT_CATKIN)
  MESSAGE(STATUS "Try to remove /usr/local/.catkin")
  EXECUTE_PROCESS(
      COMMAND ${CMAKE_COMMAND} -E remove "/usr/local/.catkin"
...
IF(EXISTS "/install_manifest.txt")
  return()
ENDIF()
FILE(READ "/home/runner/work/jrl-cmakemodules/jrl-cmakemodules/build/install_manifest.txt" files)
STRING(REPLACE "\n" ";" files "${files}")
...
ENDFOREACH(file)
EXECUTE_PROCESS(
  COMMAND ${CMAKE_COMMAND} -E remove "/home/runner/work/jrl-cmakemodules/jrl-cmakemodules/build/install_manifest.txt"
  RESULT_VARIABLE rm_resval
  OUTPUT_VARIABLE rm_out
  ERROR_QUIET
  )
