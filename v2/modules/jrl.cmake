...
```cpp
jrl_generate_options_markdown_summary(<output_file>)
```
...
### Description
  ...
  The file ends with a table containing one row per option with the following columns:
  *Option*, *Type*, *Default*, *Value*, *Condition*, *Legacy Name*, *Description*.


### Arguments
* `output_file`: Path of the Markdown file to generate.


### Example
```cmake
jrl_generate_options_markdown_summary(${CMAKE_BINARY_DIR}/OPTIONS.md)
```
#]============================================================================]
function(jrl_generate_options_markdown_summary output_file)
    _jrl_check_var_defined(output_file)

    get_property(option_names GLOBAL PROPERTY _jrl_${PROJECT_NAME}_option_names)

    set(md "# ${PROJECT_NAME} — Options Summary\n\n")
    string(APPEND md "Generated by `jrl_generate_options_markdown_summary()`.\n\n")
    ...
    foreach(option_name ${option_names})
        ...
        string(
            APPEND md
            "| `${option_name}` | `${_type}` | `${_default}` | `${_val}` | ${_cond_md} | ${_legacy_md} | ${_help} |\n"
        )
    endforeach()
